...
$querry=mysqli_query($con,"select * FROM  users where password='".$_POST['password']."' and userEmail='".$_SESSION['alogin']."'");
$count=mysqli_num_rows($querry);
if($count>0)
{
 $querry=mysqli_query($con,"update users set password='".$_POST['newpassword']."' where userEmail='".$_SESSION['alogin']."'");
