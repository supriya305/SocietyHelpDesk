                            ...
                            <div class="module-body table">
                                <table cellpadding="0" cellspacing="0" border="0"
                                    ...
                                    <tbody>
                                        ...
                                        <?php $st='closed';
$query=mysqli_query($con,"select tblcomplaints.*,users.* from tblcomplaints join users on users.id=tblcomplaints.userId  where tblcomplaints.complaintNumber='".$_GET['cid']."'");
...
?>
                                        ...
                                        <tr>
                                            ...
                                            <td><b>Flat No.</b></td>
                                            <td colspan="3"> <?php echo htmlentities($row['flatno']);?></td>

                                        </tr>
                                        <tr>
                                            <td><b>Reg Date</b></td>
                                            <td colspan="5"><?php echo htmlentities($row['regDate']);?>
                                            </td>
                                        </tr>
                                        <tr>
...
?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="updatecomplaint.php?cid=<?php echo htmlentities($row['complaintNumber']);?>"
                                                    title="Update order">
                                                    <button type="button" class="btn btn-primary">Take Action</button>
                                            </td>
                                            </a><?php } ?></td>
                                            <td colspan="4">
                                                <a href="userprofile.php?uid=<?php echo htmlentities($row['userId']);?>"
