...
$ret=mysqli_query($con,"SELECT * FROM users WHERE useremail='$username' and password='$password' and ref=1");
echo "SELECT * FROM users WHERE username='$username' and password='$password' and ref=1";
