...
$query=mysqli_query($con,"delete from tblcomplaints where userid='$userid'");
                            ...
                            <div class="module-body table">
                                ...
                                <table cellpadding="0" cellspacing="0" border="0"
                                    ...
                                    <tbody>
                                        ...
                                        <?php $query=mysqli_query($con,"select * from users where ref=0");
$cnt=1;
...
?>
                                        <tr>
                                            ...
                                            <td><a href="userprofile.php?uid=<?php echo htmlentities($row['id']);?>"
