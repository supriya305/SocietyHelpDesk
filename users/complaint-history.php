                                ...
                                <table class="table table-bordered table-striped table-condensed">
                                    <thead>
                                        <tr style="text-align: center">
                                            ...
                                            <th style="text-align: center">Status/View Details</th>
                                            <th style="text-align: center">Reopen</th>
...
while($row=mysqli_fetch_array($query))
{
  ?>
                                 ...
                                 ?></td>
                                    ...
                                    { ?>
                                                    <button type="button" class="btn btn-theme04">Not Process
                                                        Yet</button>
                                                    <?php }
 if($status=="processed"){ ?>
...
?>
		...
		$count=mysqli_fetch_array($result);
                                            ?>
                                                <a href="<?php if($count['status']=="closed")
                                                    echo"complaint-reopen.php?cid=".$row['complaintNumber'];
                                                    else ""; ?>">

                                                    <button type="button" class="btn btn-primary"
                                                        <?php if($count['status']!="closed"){ echo "disabled";} ?>>Reopen</button></a>
                                            </td>
                                        </tr>
                                        <?php } ?>
