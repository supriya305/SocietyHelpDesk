...
$Flat=$_POST['flatno'];
$tower=$_POST['tower'];
$query=mysqli_query($con,"update users set fullName='$fname',contactNo='$contactno',tower='$tower',flatno='$Flat' where userEmail='".$_SESSION['login']."'");
if($query)
{
                    ...
                    <div class="col-lg-12">
                      ...
                      {?>
                            <div class="alert alert-danger alert-dismissable">
                                <button type="button" class="close" data-dismiss="alert"
                                    aria-hidden="true">&times;</button>
                                </b> <?php echo htmlentities($_SESSION['msg']);?>
                            </div>
                            <?php }
                            $_SESSION['msg']="";?>
 ...
 ?>
                            ...
                            <form class="form-horizontal style-form" method="post" name="profile">
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="col-sm-2 col-sm-2 control-label">Tower </label>
                                    <div class="col-sm-4">
                                        <input type="text" name="tower" required="required"
                                            value="<?php echo htmlentities($row['tower']);?>" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label">Flat No. </label>
                                    <div class="col-sm-4">
                                        <input type="text" name="flatno" required="required" class="form-control"
                                            value="<?php echo htmlentities($row['flatno']);?>">
                                    </div>
