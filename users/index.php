<?php
	...
	if(isset($_POST['submit'])){
		$ret=mysqli_query($con,"SELECT * FROM users WHERE userEmail='".$_POST['username']."' and password='".$_POST['password']."' and ref=0");
        ...
        <div class="container">
            ...
            <form class="form-login" name="login" method="post">
                ...
                <div class="login-wrap">
                    ...
                    <button class="btn btn-theme btn-block" name="submit" type="submit"><i class="fa fa-lock"></i> SIGN
                        IN</button>
                    <hr>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <button class="btn btn-theme" type="submit" name="change">Submit</button>
                            </div>
                        </div>
                    </div>
                </div>
